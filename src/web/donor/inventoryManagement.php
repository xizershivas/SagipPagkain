    ...
    <div class="page-title" data-aos="fade">
      ...
      <nav class="breadcrumbs">
        <div class="container-fluid">
          <ol>
            <li><?php echo isset($_SESSION['ysnFoodBank']) && $_SESSION['ysnFoodBank'] == 1 ? 'Food Bank' : 'Donor'; ?></li>
          ...
          <div class="col-lg-3 mt-0" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="service-box">
              ...
              <div class="services-list">
                ...
                <!-- <a href="inventoryManagement.php" class="active"><i class="bi bi-trophy"></i><span>Inventory Management</span></a> -->
